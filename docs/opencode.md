...
```powershell
$env:TARGET="opencode"; irm https://raw.githubusercontent.com/yangzhaoxu411/chip-netlist-skill/v0.1.10/install.ps1 | iex
```

macOS / Linux / Git Bash:

```bash
curl -fsSL https://raw.githubusercontent.com/yangzhaoxu411/chip-netlist-skill/v0.1.10/install.sh | bash -s -- --target opencode
```
